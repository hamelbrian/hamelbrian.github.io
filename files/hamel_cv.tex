...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] ``Corruption, Party Leaders, and Candidate Selection: Evidence from Italy'' (with Raffaele Asquer and Miriam A. Golden). Revised \& Resubmitted at \textit{Legislative Studies Quarterly}.
	
	\item[] ``Who Gets a Streetlight? Race, Class, and Responsiveness in U.S. Cities'' (with Derek E. Holliday)
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Graduate Research Mentorship Program, University of California, Los Angeles, 2019-2020
	
	\item[] Graduate Student Travel Award, American Political Science Association, Elections, Public Opinion, and Voting Behavior Section, \$250, 2019
	
	\item[] Hoffenberg Fellow, University of California, Los Angeles, 2018-
	
	\item[] Fellowship in Political Psychology, University of California, Los Angeles, \$500, 2018 and 2019
...
\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Referee: \textit{American Politics Research}, \textit{Election Law Journal (x2)}, \textit{Electoral Studies}, \textit{Journal of Elections, Public Opinion and Parties}, \textit{Journal of Politics}, \textit{Political Behavior}, \textit{Political Communication}, \textit{Political Research Quarterly}, and \textit{Public Choice} \\
