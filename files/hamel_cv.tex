...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Ph.D., Political Science, University of California, Los Angeles, 
		
	\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep = -1ex, parsep = 1ex]
	
		\item[] Dissertation: \textit{Essays on Government Spending}
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] ``Political Effects and Legacy of New Deal Spending''
	
	\item[] ``Electoral Incentives and Block Grant Spending'' 
	...
	\item[] ``Opioids Epidemic and Elections'' (with Ryan Baxter-King and John B. Holbein)
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Research Assistant, John Sides, Chris Tausanovitch, and Lynn Vavreck, UCLA, 2020
...
\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Referee: \textit{American Political Science Review}, \textit{American Politics Research (x2)}, \textit{Election Law Journal (x3)}, \textit{Electoral Studies (x2)}, \textit{Journal of Elections, Public Opinion and Parties}, \textit{Journal of Politics (x2)},  \textit{Party Politics (x2)}, \textit{Political Behavior (x2)}, \textit{Political Communication}, \textit{Political Geography}, \textit{Political Research Quarterly (x2)}, and \textit{Public Choice} \\
