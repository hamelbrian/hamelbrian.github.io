...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Asquer, Raffaele, Miriam A. Golden, and \textbf{Brian T. Hamel}. Forthcoming. \href{https://www.brianhamel.me/files/italy.pdf}{``Corruption, Party Leaders, and Candidate Selection: Evidence from Italy.''} \textit{Legislative Studies Quarterly}.
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] ``Income Inequality and Redistributive Attitudes'' (with Eunji Kim and Sara M. Kirshbaum)
...
\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Referee: \textit{American Political Science Review}, \textit{American Politics Research}, \textit{Election Law Journal (x3)}, \textit{Electoral Studies (x2)}, \textit{Journal of Elections, Public Opinion and Parties}, \textit{Journal of Politics (x2)}, \textit{Political Behavior}, \textit{Political Communication}, \textit{Political Geography}, \textit{Political Research Quarterly}, and \textit{Public Choice} \\
