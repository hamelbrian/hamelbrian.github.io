...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] ``Black Workers in White Places: Daytime Racial Diversity and White Public Opinion'' (with Bryan Wilcox-Archuleta). Revised \& Resubmitted, \textit{Journal of Politics}.
