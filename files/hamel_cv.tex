...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep = -1ex, parsep = 1ex]
		...
		\item[] Dissertation: \textit{Essays on Distributive Politics}
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] \href{https://www.brianhamel.me/files/context.pdf}{``Black Workers in White Places: Daytime Racial Diversity and White Public Opinion''} (with Bryan Wilcox-Archuleta). Revised \& Resubmitted, \textit{Journal of Politics}.
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] ``Electoral Incentives in City Block Grant Spending'' 

	\item[] ``Political Effects of New Deal Spending''
	...
	\item[] ``Congressional Staff and the Distribution of Federal Spending'' (with Joshua McCrain)
	
	\item[] ``Party Control and Education Spending'' (with Melissa L. Sands)

	\item[] ``Context and Early Voting Turnout'' (with Jan E. Leighley and Robert M. Stein)
	...
	\item[] ``Parties, Campaign Finance, and Polarization'' (with Aaron M. Goldzimer, John A. Henderson, and Shawn Patterson, Jr.)
...
\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep = -1ex, parsep = 1ex]
		...
		\item[] Reader, PS200C: Causal Inference for Social Science, Spring 2020
...
\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Referee: \textit{American Political Science Review}, \textit{American Politics Research}, \textit{Election Law Journal (x3)}, \textit{Electoral Studies (x2)}, \textit{Journal of Elections, Public Opinion and Parties}, \textit{Journal of Politics (x2)}, \textit{Political Behavior (x2)}, \textit{Political Communication}, \textit{Political Geography}, \textit{Political Research Quarterly (x2)}, and \textit{Public Choice} \\
