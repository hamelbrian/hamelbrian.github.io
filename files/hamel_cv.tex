...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Ph.D., Political Science, University of California, Los Angeles, 2016-
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] \href{https://www.brianhamel.me/files/new_deal.pdf}{``The Means Matter, Too: Policy and Economic Retrospective Voting in American National Elections''}
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] ``Money and Turnout: Evidence from Alaska's UBI''
	
	\item[] ``Political Bias in Education Spending''
