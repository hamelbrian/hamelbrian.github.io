...
\begin{minipage}{0.5\linewidth}
  \begin{tabular}{ll}
    ...
    Website: & \texttt{https://brianhamel.net/} \\
  \end{tabular}
\end{minipage}
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] M.A., Political Science, University of California, Los Angeles, 2019 (expected)
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] ``Who Donates to Party Switchers?'' (with Antoine Yoshinaka). Revised \& Resubmitted at \textit{American Politics Research}. 
	
	\item[] ``Corruption, Party Leaders, and Candidate Selection: Evidence from Italy'' (with Raffaele Asquer and Miriam A. Golden)
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	% \item[] ``Quality of Work Life and Political Participation''
	
	% \item[] ``An Occupation-Based Theory of Self-Interest and Political Preferences''
	
	%\item[] ``Occupational Status and Political Preferences''

	\item[] ``Electoral Competition, Early Voting, and Election Day Turnout'' (with Jan E. Leighley, Robert M. Stein, and Lynn Vavreck)
	
	\item[] ``Partisans, Nonpartisans, and Presidential Campaign Advertisements'' (with Lynn Vavreck)

	\item[] ``Right-to-Work Laws and the Political Activism of Labor Unions'' (with Soumyajit Mazumder) 

	\item[] ``Nonpolicy Responsiveness in U.S. Cities'' (with Derek E. Holliday)

	\item[] ``Dynamic Racial Contexts and Political Behavior'' (with Bryan Wilcox-Archuleta)
	
	\item[] ``Campaign Finance Limits in the U.S. States'' (with Aaron M. Goldzimer, John A. Henderson, and Shawn Patterson, Jr.)

	\item[] ``The Political Legacy of Head Start'' (with John B. Holbein, Soumyajit Mazumder, and Alan N. Yan)

	\item[] ``The Health and Culture of American Political Parties'' (with Anand E. Sokhey)
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Hoffenberg Fellow, University of California, Los Angeles, 2018-
	
	\item[] Fellowship in Political Psychology, University of California, Los Angeles, \$500, 2018
...
\begin{enumerate}[topsep = 0pt, itemsep = 1ex, partopsep  = 1ex, parsep = 1ex]
	...
	% \item[] Research Associate, U.S. Democracy Tracker, 2019-
	
	\item[] Research Assistant, Miriam A. Golden, University of California, Los Angeles, 2018-
...
\begin{enumerate}[topsep = 0pt, itemsep = -1ex, partopsep  = 1ex, parsep = 1ex]
	...
	\item[] Referee: \textit{American Politics Research}, \textit{Election Law Journal (x2)}, \textit{Electoral Studies}, \textit{Journal of Elections, Public Opinion and Parties}, \textit{Journal of Politics}, \textit{Political Behavior}, \textit{Political Communication}, and \textit{Public Choice} \\
